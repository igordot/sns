...
if [[ "$genome_build" == "hg19" ]] ; then
	...
	annovar_protocol="refGene,avsnp150,gnomad41_exome,gnomad41_genome,kaviar_20150923,cosmic99,intervar_20180118,clinvar_20240611,revel,dbnsfp33a"
	annovar_operation="g,f,f,f,f,f,f,f,f,f"
	annovar_argument="'--splicing_threshold 10',,,,,,,,,"
	annovar_cols_grep="^Ref|^Alt|refGene|avsnp|gnomad41_exome_AF$|gnomad41_genome_AF$|Kaviar_AF|cosmic|InterVar|CLNSIG|REVEL|CADD|fathmm"
